...
declare const StyledSortIcon: import("@stitches/react/types/styled-component").StyledComponent<"svg", {
    visible?: boolean | "true" | undefined;
    ascending?: boolean | "true" | undefined;
}, {
    xs: string;
    sm: string;
    md: string;
...
declare type SortIconVariants = VariantProps<typeof StyledSortIcon>;
declare type NativeAttrs = Omit<React.SVGAttributes<SVGElement>, keyof SortIconVariants>;
export declare type TableSortIconProps = SortIconVariants & NativeAttrs & {
    css?: CSS;
};
export declare const ICON_SIZE = 22;
