...
export declare const StyledCol: import("@stitches/react/types/styled-component").StyledComponent<"div", {}, {
    xs: string;
    sm: string;
    md: string;
    lg: string;
...
export declare type ColVariantsProps = VariantProps<typeof StyledCol>;
