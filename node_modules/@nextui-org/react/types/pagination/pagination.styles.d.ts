...
export declare const StyledPaginationEllipsis: import("@stitches/react/types/styled-component").StyledComponent<"svg", {
    isEllipsis?: boolean | "true" | undefined;
    isBefore?: boolean | "true" | undefined;
}, {
    xs: string;
    sm: string;
    md: string;
...
export declare type PaginationItemVariantsProps = VariantProps<typeof StyledPaginationItem>;
export declare type PaginationHighlightVariantsProps = VariantProps<typeof StyledPaginationHighlight>;
