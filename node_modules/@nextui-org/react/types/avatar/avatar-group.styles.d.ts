...
export declare const StyledAvatarGroupCount: import("@stitches/react/types/styled-component").StyledComponent<"span", {}, {
    xs: string;
    sm: string;
    md: string;
    lg: string;
...
export declare const StyledAvatarGroup: import("@stitches/react/types/styled-component").StyledComponent<"div", {
...
export declare type AvatarGroupVariants = VariantProps<typeof StyledAvatarGroup>;
