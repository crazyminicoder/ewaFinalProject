...
export declare const StyledCollapseView: import("@stitches/react/types/styled-component").StyledComponent<"div", import("@stitches/react/types/styled-component").StyledComponentProps<[{
    w: string;
    d: string;
    ta: string;
    bg: string;
